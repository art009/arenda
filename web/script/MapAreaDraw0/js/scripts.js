...
var Painter = new function(){
	...
	var addBtn = function(){
		nodes['add'] = nodes['buttons'].appendChild(_.node('input', {'type':'button', 'value':'Новый блок'}));
		nodes['add'].onclick = add;
	};
	
	var saveBtn = function(){
		nodes['save'] = nodes['buttons'].appendChild(_.node('input', {'type':'button', 'value':'Сохранить'}));
