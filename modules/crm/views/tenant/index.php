...
/* @var $searchModel app\models\search\Tenant */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Список арендаторов';
...
//            'id',
            'name',
            [
                'attribute' => 'type_tenant',
                'value'=> function($data){return Tenant::labelTypeTenant()[$data->type_tenant];},
                'filter' => Tenant::labelTypeTenant(),
            ],
